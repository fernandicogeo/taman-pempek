...
func (cn *controller) GetCategorys(c *gin.Context) {
	categorys, err := cn.categoryService.FindAll()
	...
	var categorysResponse []CategoryResponse

	for _, category := range categorys {
		categoryResponse := convertToCategoryResponse(category)

		categorysResponse = append(categorysResponse, categoryResponse)
	}
